...
<div class="p-6 max-w-xl">
    <h1 class="text-2xl font-bold text-gray-800 mb-6">Registrar Especialidad</h1>

    <form method="POST" action="{{ route('specialties.store') }}" class="bg-white p-6 rounded-lg shadow">
        @csrf
            <div class="mb-4">
