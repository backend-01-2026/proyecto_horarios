...
<html lang="es">
  ...
  <body
    class="flex min-h-screen p-4 bg-gradient-to-br from-red-900 via-red-700 to-red-500 items-center justify-center"
  >
    <div
      class="overflow-hidden grid w-full max-w-6xl bg-white rounded-3xl shadow-2xl lg:grid-cols-2"
    >
      <div
        class="hidden flex-col p-10 text-white bg-gradient-to-b from-red-900 to-red-700 justify-center items-center lg:flex"
      >
        <img
